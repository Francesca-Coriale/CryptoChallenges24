...
int main(int argc, char **argv){
       ...
       //pedantic mode? Check if md == NULL
        ...
        EVP_PKEY *hkey;
        hkey = EVP_PKEY_new_mac_key(EVP_PKEY_HMAC, NULL, key, 32); //key for SHA256 = 256 bits = 32 bytes
        ...
        while((n = fread(buffer,1,MAXBUF,f_in_1)) > 0){
        // Returns 1 for success and 0 for failure.
